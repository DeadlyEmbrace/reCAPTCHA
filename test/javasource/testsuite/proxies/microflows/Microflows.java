...
public class Microflows
{
	...
	public static recaptcha.proxies.SiteKey gET_Sitekey(IContext context, testsuite.proxies.Color _color)
	{
		try
		{
			Map<String, Object> params = new HashMap<String, Object>();
			params.put("Color", _color == null ? null : _color.getMendixObject());
			IMendixObject result = (IMendixObject)Core.execute(context, "TestSuite.GET_Sitekey", params);
